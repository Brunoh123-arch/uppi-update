  ...
  Widget build(BuildContext context) {
    return AppResponsiveDialog(
      ...
      secondaryButton: AppPrimaryButton(
        ...
        onPressed: () async {
          final result = await locator<HomeRepository>().sendSosSignal(
            orderId: orderId,
          );
          result.fold((l) => context.showErrorSnackBar(l.errorMessage, fallback: 'Não foi possível enviar o alerta SOS.'), (
            r,
          ) {
