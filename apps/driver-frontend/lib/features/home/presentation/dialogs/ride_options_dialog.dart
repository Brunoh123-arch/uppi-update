...
import 'package:uppi_motorista/features/home/presentation/dialogs/cancel_ride_reason.dart';
...
class RideOptionsSheet extends StatelessWidget {
  ...
  const RideOptionsSheet({super.key, required this.orderId});
          ...
          AppListButton(
            ...
            onPressed: () {
              ...
              showDialog(
                ...
                useSafeArea: false,
                builder: (context) {
                  return CancelRideReasonDialog(orderId: orderId);
                },
              );
            },
          ),
