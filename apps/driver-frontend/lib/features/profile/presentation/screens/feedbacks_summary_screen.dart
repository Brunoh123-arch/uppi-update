...
import 'package:uppi_motorista/features/profile/presentation/components/feedbacks_summary_empty_state.dart';
import 'package:uppi_motorista/features/profile/presentation/components/rating_gauge.dart';
                    ...
                    BlocBuilder<FeedbacksSummaryCubit, FeedbacksSummaryState>(
                      builder: (context, state) {
                        return state.map(
                          ...
                          loading: (loading) => const FeedbacksSummarySkeleton(),
                          error: (value) => Text(friendlyErrorMessage(value.errorMessage)),
                            ...
                            return SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 12),
                                  ...loaded.summary.goodReviews.map(
                                    (e) => Padding(
