...
class WizardSteps extends StatelessWidget {
  ...
  Widget get gradientHorizontalLine => Container(
    ...
    decoration: const BoxDecoration(
      ...
      gradient: LinearGradient(colors: [Color(0xff2892FF), Color(0xff45FCDE)]),
    ),
  );

  Widget get dottedHorizontalLine =>
      const DottedLine(lineThickness: 4, dashColor: ColorPalette.neutral90);
}
