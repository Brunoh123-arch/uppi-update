...
class _$VehicleModelEntityImpl implements _VehicleModelEntity {
  const _$VehicleModelEntityImpl(
      {required this.id, required this.name, this.category = 'carro'});
  ...
  @override
  String toString() {
    return 'VehicleModelEntity(id: $id, name: $name, category: $category)';
  }
...
abstract class _VehicleModelEntity implements VehicleModelEntity {
  const factory _VehicleModelEntity(
      ...
      final String category}) = _$VehicleModelEntityImpl;
