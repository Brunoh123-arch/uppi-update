...
/// Gera QR Code PIX para recarga de wallet do passageiro
            ...
            if (_errorMessage != null) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: ColorPalette.error60.withValues(alpha: 0.3),
                  ),
                ),
                child: Row(
                  children: [
          ...
          ScaleTransition(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: ColorPalette.semanticgreen50.withValues(alpha: 0.3),
                    blurRadius: 24,
                    offset: const Offset(0, 4),
                  ),
                ],
