...
class MobileLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    final cardSize = layoutChild(
      ...
      BoxConstraints(
        maxWidth: size.width,
        maxHeight: size.height - keyboardHeight,
      ),
    );
    if (cardSize.height < size.height) {
      positionChild(
        cardLayoutId,
        Offset(0, size.height - cardSize.height - keyboardHeight),
      );
      ...
      positionChild(
        ...
        Offset(
          ...
          size.height - cardSize.height - myLocationSize.height - keyboardHeight,
        ),
      );
    } else {
      layoutChild(
