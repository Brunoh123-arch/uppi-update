...
class LocationMarkerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Se heading for nulo (como em emuladores desktop sem sensor), usamos 135 graus como fallback
    // para manter o mockup visível na direção correta. No dispositivo físico real com sensores,
    // o valor magnético em tempo real assume o controle.
    final double finalHeading = heading ?? 135.0;

    // Conversão de bússola magnética para coordenadas cartesianas do Canvas
    // O heading magnético 0 representa o Norte (para cima na tela).
    // Em coordenadas do Canvas do Flutter, 0 graus é para a direita (Leste).
    // Subtraímos 90 graus para alinhar.
    ...
    canvas.drawArc(
      ...
      startAngle,
      sweepAngle,
      true, // useCenter = true desenha o cone a partir do centro
      conePaint,
    );
