...
class _RideHistoryDetailsScreenMobileState extends State<RideHistoryDetailsScreenMobile> {
  ...
  Future<void> _loadRouteGeometry() async {
    try {
      ...
      try {
        ...
        debugPrint('[Google-History-Mobile] Error loading route_polyline from DB: $e');
      }
      ...
      if (points.isEmpty) {
        try {
          ...
          debugPrint('[Google-History-Mobile] Exception: $e');
        }
      }
      ...
      if (points.isEmpty) {
        try {
          ...
          debugPrint('[OSRM-History-Mobile] Exception: $e');
        }
      }
  ...
  Future<void> _handleReopenChat() async {
    ...
    try {
      ...
      if (mounted) {
        context.showSnackBar(message: 'Chat reaberto! Você pode falar com o motorista.');
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PostRideChatScreen(
              rideId: widget.entity.id,
              driverName: widget.entity.driver?.fullName ?? 'Motorista',
            ),
          ),
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    final endedAt = widget.entity.endedAt;
    final isWithin24Hours = endedAt != null && now.difference(endedAt).inHours < 24;
                            ...
                            return AppGenericMap(
                              ...
                              onControllerReady: (controller) {
                                controller.fitBounds(
                                  widget.entity.waypoints.latLngs,
                                );
                              },
                            );
                          },
              ...
              SizedBox(
                ...
                child: AppBorderedButton(
                  ...
                  title: _reopeningChat
                      ? 'Abrindo chat...'
                      : 'Contatar Motorista (Objeto Esquecido)',
                  isPrimary: true,
