  ...
  Future<void> _loadRouteGeometry() async {
    try {
      ...
      try {
        ...
        debugPrint('[Google-History-Desktop] Error loading route_polyline from DB: $e');
      }
      ...
      if (points.isEmpty) {
        try {
          ...
          debugPrint('[Google-History-Desktop] Exception: $e');
        }
      }
      ...
      if (points.isEmpty) {
        try {
          ...
          debugPrint('[OSRM-History-Desktop] Exception: $e');
        }
      }
