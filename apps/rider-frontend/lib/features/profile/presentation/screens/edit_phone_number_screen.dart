...
class _EditPhoneNumberScreenState extends State<EditPhoneNumberScreen>
  ...
  String _translateError(String error) {
    ...
    if (error.contains('Phone number format')) return 'Formato de número inválido. Use +55 seguido do DDD e número.';
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: AppTopBar(title: 'Alterar Celular'),
                  ),
                ],
              ),
            ),
                  ...
                  return Expanded(
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isActive ? colorScheme.primary : colorScheme.onSurface.withValues(alpha: 0.12),
  ...
  Widget _buildEnterPhoneStep(ColorScheme colorScheme) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Informe o novo número que deseja usar. Vamos enviar um código SMS para confirmar.',
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: _loading
                ...
                : const Text('Enviar Código SMS', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          ),
        ),
      ],
    );
  ...
  Widget _buildVerifyOtpStep(ColorScheme colorScheme) {
    return Column(
      ...
      children: [
        ...
        // Campo OTP — 6 dígitos individuais
        Text(
