  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(image: widget.cardImage, fit: BoxFit.cover),
      ),
      child: Column(
        ...
        children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(widget.bankName, style: context.titleLarge),
                    ),
                ...
                Text(context.t.nameOnCard, style: context.bodyMedium),
                const SizedBox(height: 8),
                Text(widget.accountHolderName, style: context.labelMedium),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Text(widget.accountNumber, style: context.titleSmall),
                ),
                CupertinoSwitch(
