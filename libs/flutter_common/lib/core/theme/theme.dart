...
class AppTheme {
  ...
  static ThemeData dark(String fontPrimary, String fontSecondary) {
    final localTextTheme = textThemeDark(fontPrimary, fontSecondary);
    return light(fontPrimary, fontSecondary).copyWith(
      ...
      segmentedButtonTheme: SegmentedButtonThemeData(
        ...
        style: ButtonStyle(
          side: WidgetStatePropertyAll(
            BorderSide(color: darkColorScheme.outline.withValues(alpha: 0.2)),
          ),
          shape: WidgetStatePropertyAll(
            RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          ),
          ...
          foregroundColor: WidgetStateColor.resolveWith((states) {
            if (states.contains(WidgetState.selected)) {
              ...
              return darkColorScheme.onSurface.withValues(alpha: 0.6);
            }
          }),
          backgroundColor: WidgetStateColor.resolveWith((states) {
            if (states.contains(WidgetState.selected)) {
              ...
              return darkColorScheme.primary.withValues(alpha: 0.12);
            } else {
              return Colors.transparent;
            }
          }),
